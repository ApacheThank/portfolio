...
<div class="basis-4/5 ml-6 mt-8 bg-white dark:bg-gray-900">
    <article class="mx-auto max-w-screen-xl text-gray-900 rounded-lg dark:text-white pl-2">
        <div class="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
            <h2 class="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">{{$post['title']}}</h2>
